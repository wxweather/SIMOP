'open ersst_oisst_1x1_clim_81-10.daily.365.ctl'
pi=sstcalc( 1,365,"clima_sst_diario.prn") 
'close 1'
'open ersst_oisst_1x1_clim_81-10.daily.366.ctl'
pi=sstcalc( 1,365,"clima_sst_diario_ab.prn") 
'close 1'
'open ersst_oisst_1x1_clim_81-10.ctl'
pi=sstcalc( 1,12,"clima_sst_mensal.prn") 
'close 1'
...
ninoregions(1)
'd aave(sst-000.00,lon='_x1',lon='_x0',lat='_y0',lat='_y1')'
...
pi=write(arqout,ano' 'mesx' 'dia' 't' 'tsm1' 'tsm2' 'tsm12' 'tsm3' 'tsm4' 'tsm3.4' 'tsmcbm) 
